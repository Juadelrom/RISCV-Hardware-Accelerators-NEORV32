/*******************************************************************************
 * Archivo:     neorv32_aes128_validacion_v2.h
 ...
 *
 * Descripción:
 * Archivo de cabecera de la librería AES-128 optimizada con extensiones Zkne y
 * Zknd (versión 2) modificada para la impresión de los vectores de ronda para
 * la prueba de validación de vectores del NIST. Se incluyen constantes y proto-
 * tipos de funciones de control.
 ******************************************************************************/

#ifndef NEORV32_AES128_VALIDACION_V2_H

#define NEORV32_AES128_VALIDACION_V2_H
